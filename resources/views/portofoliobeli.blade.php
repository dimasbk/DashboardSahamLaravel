    ...
    <div class="content">
        <div class="container">
            ...
            <div class="table-responsive">
                <table id="portofolioBeli" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr scope="row">
                            ...
                            <td>
                                <button onclick="location.href='/portofoliobeli/edit/{{$item->id_portofolio_beli}}'"
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button
                                                ...
                                                type="button" class="btn btn-primary">Delete Data</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
